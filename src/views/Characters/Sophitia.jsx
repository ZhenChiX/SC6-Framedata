...
class Sophitia extends Component {
  ...
  render() {
    ...
    // Under Slide Blade	12	10	2	-6	+6	+6	1.67%
    // :2::A:	:SL:	TC[8~]
    // Iron Butterfly	28	15	3	-16	-6	-6	1.67%
    // :1::A:	:L:	TC[14~]
    // Iron Butterfly	28	15,25	8	-24	KND	KND	3.33%
    // :1::A::A:	:L::M:	TC / NC / i28,24
    // Cutlass Europa	18	18	3	-10	+4	+4	1.67%
    // :4::A:	:H:	TC[8-12]
    // Cutlass Europa	18	18,15	6	-16	KND	KND	3.33%
    // :4::A::A:	:H::L:	i18,38
    // Cutlass Europa	18	18,15,25(53)	11	-24	KND	KND	5%
    // :4::A::A::A:	:H::L::M:	i18,38,24
    // Cutlass Seraphim	18	18,20	9	-16	KND	KND	8.33%
    // :4::A::B:	:H::M:	NC / i18,28
    // Cutlass Europa	38	30	6	-2	STN	STN	4%
    // :4::(A):	:H:	TC[8-28] / STN[16]
    // Cutlass Europa	38	74	18	-16	KND	KND	9%
    // :4::(A)::A::A::A:	:H::L::M::L:	NC
    // Under Slide Blade	12	10	2	-6	+6	+6	1.67%
    // FC :A:	:SL:	TC
    // Full Turn Blade	16	18	3	-10	+4	+4	1.67%
    // WR :A:	:M:	TC[~8]
    // Jumping Mirage Satellite	24	35	7	-8	KND	KND	4%
    // :9::A:	:H:	TJ[4~]
    // Jumping Mirage Satellite	24	30	7	-8	KND	KND	4%
    // :8::A:	:H:	TJ[4~]
    // Jumping Mirage Satellite	24	25	7	-8	+2	+2	4%
    // :7::A:	:H:	TJ[4~]
    // Turning Slide Blade	14	12	2	-4	+7	+7	1.67%
    // BT :A:	:H:
    // Under Slide Blade	16	14	2	-4	+6	+6	1.67%
    // BT :2::A:	:SL:
    ...
    console.log(sophitiaFrameData.verticalAttacks.length);
