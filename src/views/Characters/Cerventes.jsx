...
class Cervantes extends Component {
  constructor(props) {
    super(props);
    ...
    const cervanteslFrameData = {
      ...
      verticalAttacks: [
        ...
        },
        {
          ...
          move: [
            <Fragment>
              <p>Half-Mast Wave ~ Dread Charge</p>
              {d6}
              {a}
              {a_h}
            </Fragment>
        ...
        },
        {
          ...
          move: [
            <Fragment>
              <p>Deadly Torrent ~ Dread Charge</p>
              {d1}
              {aSM}
              {b}
              {b}
      ...
      horizontalAttacks: [
        ...
        },
        {
          ...
          note: [
            <Fragment>
              {at}
              <p>Become attack throw against midair opponent</p>
              {lh}
              <p>
                Triggers upon hitting opponent with gun technique 12 or more
                times
              </p>
            </Fragment>
          ]
        },
        {
          ...
          note: [<Fragment >
            {gi}
            <p>GI vs High/Mid horizontal attakcs except Kicks</p>
          </Fragment>]
        },
        {
          id: 27,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    ...
                    tableData={cervanteslFrameData.verticalAttacks.map(data => [
                      data.command,
                      data.impact,
                      data.onBlock,
                      data.onHit,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.horizontalAttacks.map(
                      data => [
                        data.command,
                        data.impact,
                        data.onBlock,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.kicks.map(data => [
                      data.command,
                      data.impact,
                      data.onBlock,
                      data.onHit,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.dualButtonAttacks.map(
                      data => [
                        data.command,
                        data.impact,
                        data.onBlock,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.eightwayrunAttack.map(
                      data => [
                        data.command,
                        data.impact,
                        data.onBlock,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.throws.map(data => [
                      data.command,
                      data.impact,
                      data.onBlock,
                      data.onHit,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.reversalEdge.map(data => [
                      data.command,
                      data.impact,
                      data.onBlock,
                      data.onHit,
              ...
              <CardBody>
                {this.state.display ? (
                  <Table
                    tableHeaderColor="primary"
                    tableHead={this.state.tableHeadData}
                    tableData={cervanteslFrameData.gaugeAttacks.map(data => [
                      data.command,
                      data.impact,
                      data.onBlock,
                      data.onHit,
...
export default withStyles(styles)(Cervantes);
